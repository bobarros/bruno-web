  ...
  return (
    <Wrap>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 373.232 373.232">
        <path fill="#fff" d="M30,361l23-65c0,0-45.6-66.2-43-118S39,6,188.7,6C337,6,365,176.1,365,196.7c0,0-39.5,153.5-156,153.5 s-83-6.2-83-6.2L30,361z"/>
